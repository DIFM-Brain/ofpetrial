...
Let's first create a plot information using `prep_plot_f()`.
...
Let's now create experiment plots using `make_exp_plots()` to a two-input case.
...
Let's take a look at `exp_plots` variable of `exp_data`. You can access them just like you access a regular variable using $ (or any other methods to pull them).
