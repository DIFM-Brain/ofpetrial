...
temp_folder = "_temp-folder-here_"
all_trial_info = readRDS(file.path(temp_folder, "all_trial_info.rds"))
machine_table = readRDS(file.path(temp_folder, "machine_table.rds"))
# === packages ===#
# library(bookdown)
# library(pracma)
# library(furrr)
