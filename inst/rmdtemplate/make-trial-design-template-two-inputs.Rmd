...
kable(ab_line_1, 
      ...
      digits = 7,
      caption = paste0("AB-line for ", all_trial_info$input_name[[1]]))
```
...
```{r echo=FALSE}
  kable(ab_line_2, 
        col.names = c("Lat", "Long"),
        digits = 7,
        caption = paste0("AB-line for ", all_trial_info$input_name[[2]]))
```
